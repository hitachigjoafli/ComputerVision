...
ap.add_argument("-i", "--image", default='images',
    ...
    if image_file[-4:]==".jpg":
        ...
        if len(idxs) > 0:
            ...
            for i in idxs.flatten():
                ...
                cv2.putText(image, text, (x, y +35), cv2.FONT_HERSHEY_SIMPLEX,
                    0.5, color, 2)
        ...
        # show the output image
            cv2.imshow("Image", image)
            for e in range(len(classIDs)):
                print(e, "Label: ",LABELS[classIDs[e]],"Confidence:", confidences[e])
